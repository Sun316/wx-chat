...
var postData = require('../../data/data1.js');
//引入全局
var app = getApp()
//初始对话
var i = 0;
...
Page({
  data: {
    ...
    viewBg: 'white',
    feedback: [{
      content: '对于最新的抗衰技术，还有很多人不甚了解，到底热拉提，超声刀，热玛吉三者之间那个更适合你呢？做完下面的这些题，你就知道啦～',
      content_type: 0,
      contract_info: '',
      myDate: '',
      role: true,
      maxV: '',
      title: '000001u103y721g3',
      img: "../../images/hotapp_01_07.png"
    }, {
        content: "http://deer.ysigntech.com/upload/qYfmwk/head2.jpg",
      content_type: 1,
      contract_info: '',
      myDate: '',
      role: true,
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      title: "逆龄抗衰神器了解一下？",
      path: '/pages/feedback2/index',
      imageUrl: "http://deer.ysigntech.com/upload/qYfmwk/head2.jpg",
      success: function (res) {
        // 转发成功
      },
      fail: function (res) {
