...
var dataList = getApp().globalData.dataList2;
var answer;
Page({
  /**
  * 页面的初始数据
  */
  ...
  onShow: function () {
    ...
    dataList = getApp().globalData.dataList2[2];

    if (answer == 'a') {
      dataList = getApp().globalData.dataList2[0];
    }
    if (answer == 'b') {
      dataList = getApp().globalData.dataList2[1];
    } if (answer == 'c') {
      dataList = getApp().globalData.dataList2[2];
    } if (answer == 'd') {
      dataList = getApp().globalData.dataList2[3];
    }
